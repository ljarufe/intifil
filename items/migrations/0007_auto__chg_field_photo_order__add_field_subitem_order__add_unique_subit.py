...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'items_photo', 'order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
        # Adding field 'SubItem.order'
        db.add_column(u'items_subitem', 'order',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Photo.order'
        db.alter_column(u'items_photo', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Deleting field 'SubItem.order'
        db.delete_column(u'items_subitem', 'order')
    ...
    models = {
        ...
        u'items.subitem': {
            'Meta': {'unique_together': "(('item', 'order'),)", 'object_name': 'SubItem'},
