...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.item'
        db.add_column(u'teams_team', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teams.Item']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.item'
        db.delete_column(u'teams_team', 'item_id')
